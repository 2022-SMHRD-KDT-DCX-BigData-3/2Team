...
<body>
	...
	<header id="header" class="header fixed-top d-flex align-items-center">
		...
		<div class="d-flex align-items-center justify-content-between">
			<a href="http://localhost:9999/main"
				class="logo d-flex align-items-center"> <img
				src="assets/img/smh.png" alt=""> <span
				class="d-none d-lg-block">Smart Groupware</span>
			...
			<ul class="d-flex align-items-center">
				...
				<li class="nav-item dropdown pe-3"><a
					...
					href="#" data-bs-toggle="dropdown"> <img
						src="assets/img/pro.png" alt="Profile" class="rounded-circle">
					...
					<ul
						...
						<li class="dropdown-header">
							<h6>${user.MEMBER_NAME}</h6> <c:if
								test="${user.DEPART_CODE eq '1'}">
								<span>비서실</span>
							</c:if> <c:if test="${user.DEPART_CODE eq '2'}">
								<span>인사부</span>
							</c:if> <c:if test="${user.DEPART_CODE eq '3'}">
								<span>총무부</span>
							</c:if> <c:if test="${user.DEPART_CODE eq '4'}">
								<span>생산부</span>
							</c:if> <c:if test="${user.DEPART_CODE eq '5'}">
								<span>홍보부</span>
							</c:if> <c:if test="${user.DEPART_CODE eq '6'}">
								<span>관리부</span>
							</c:if> <c:if test="${user.RANK_CODE eq '1'}">
								<span>사장</span>
							</c:if> <c:if test="${user.RANK_CODE eq '2'}">
								<span>부사장</span>
							</c:if> <c:if test="${user.RANK_CODE eq '3'}">
								<span>전무</span>
							</c:if> <c:if test="${user.RANK_CODE eq '4'}">
								<span>상무</span>
							</c:if> <c:if test="${user.RANK_CODE eq '5'}">
								<span>이사</span>
							</c:if> <c:if test="${user.RANK_CODE eq '6'}">
								<span>부장</span>
							</c:if> <c:if test="${user.RANK_CODE eq '7'}">
								<span>차장</span>
							</c:if> <c:if test="${user.RANK_CODE eq '8'}">
								<span>과장</span>
							</c:if> <c:if test="${user.RANK_CODE eq '9'}">
								<span>대리</span>
							</c:if> <c:if test="${user.RANK_CODE eq '10'}">
								<span>사원</span>
							</c:if>
						</li>
						<li>
				  	...
				  	<path
						...
						<li><a class="dropdown-item d-flex align-items-center"
							href="room"> <svg xmlns="http://www.w3.org/2000/svg"
									width="16" height="16" fill="currentColor"
				  ...
				  <path
						...
						<li><a class="dropdown-item d-flex align-items-center"
							href="list"> <svg xmlns="http://www.w3.org/2000/svg"
									width="16" height="16" fill="currentColor"
...
>>>>>>> branch 'main' of https://github.com/2022-SMHRD-KDT-DCX-BigData-3/2Team.git
			...
			<li class="nav-item"><a class="nav-link collapsed" href="list">
					<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
...
<<<<<<< HEAD
			...
			</svg>&nbsp;&nbsp; <span>전자결재</span><i class="bi bi-chevron-down ms-auto"></i>
			</a>
				<ul id="components-nav" class="nav-content collapse "
					data-bs-parent="#sidebar-nav">
					<li><a href="approvaln"> <i class="bi bi-circle"></i><span>결재조회</span>
					</a></li>
					<li><a href="approvalp"> <i class="bi bi-circle"></i><span>결재신청</span>
					</a></li>
				</ul></li>
			<!-- End Components Nav -->
=======
...
<<<<<<< HEAD
			...
			<li class="nav-item"><a class="nav-link collapsed"
				href="commuting"> <svg xmlns="http://www.w3.org/2000/svg"
...
>>>>>>> branch 'main' of https://github.com/2022-SMHRD-KDT-DCX-BigData-3/2Team.git
			...
			<c:if test="${user.MEMBER_id == '1'}">
				<li class="nav-item"><a class="nav-link collapsed"
					href="member"> <svg xmlns="http://www.w3.org/2000/svg"
							width="16" height="16" fill="currentColor"
							class="bi bi-person-lines-fill" viewBox="0 0 16 16">
			  <path
								d="M6 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm-5 6s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H1zM11 3.5a.5.5 0 0 1 .5-.5h4a.5.5 0 0 1 0 1h-4a.5.5 0 0 1-.5-.5zm.5 2.5a.5.5 0 0 0 0 1h4a.5.5 0 0 0 0-1h-4zm2 3a.5.5 0 0 0 0 1h2a.5.5 0 0 0 0-1h-2zm0 3a.5.5 0 0 0 0 1h2a.5.5 0 0 0 0-1h-2z" />
			</svg>&nbsp;&nbsp; <span>직원조회/관리</span>
				</a></li>
				<!-- End member Nav -->
			</c:if>
